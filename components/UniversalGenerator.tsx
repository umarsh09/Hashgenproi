            ...
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                {['Instagram', 'TikTok', 'LinkedIn', 'YouTube', 'Email'].map(p => (
                    <button 
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-medium transition-colors border ${platform === p ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800'}`}
                    >
                        {p}
                    </button>
                ))}
